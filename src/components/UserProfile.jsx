  ...
  return (
    <div className="nav-item absolute right-1 top-16 bg-white dark:bg-[#42464d] p-8 rounded-lg w-96">
      ...
      <div className="flex gap-5 items-center mt-6 border-color border-b-1 pb-6">
        ...
        <div>
          <p className="font-semibold text-xl dark:text-gray-200">Ruan Azeredo</p>
          <p className="text-gray-500 text-sm dark:text-gray-400">Developer</p>
          <p className="text-gray-500 text-sm font-semibold dark:text-gray-400">ruanazeredo@gmail.com</p>
        </div>
      </div>
      <div>
