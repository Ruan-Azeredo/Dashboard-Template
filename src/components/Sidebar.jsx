...
const Sidebar = () => {
  ...
  const activeLink = 'flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg lext-white text-md m-2'
  const normalLink = 'flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg lext-white m-2 text-gray-700 dark:text-gray-200 dark:hover:text-black hover:bg-light-gray m-2'
